...
client.on('ready', () => {
  ...
  // You can add additional setup logic here, like registering application commands
  client.application.commands.create(client.commands.map((command) => command.data));
});
